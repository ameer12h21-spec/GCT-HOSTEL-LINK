...
export default function MessOwnerLayout({ children }: { children: ReactNode }) {
    ...
    <div className="flex h-screen bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="lg:hidden flex items-center justify-between h-14 px-4 border-b border-border bg-background">
          <Button variant="ghost" size="icon" onClick={() => setMobileSidebarOpen(true)}><Menu className="w-5 h-5" /></Button>
