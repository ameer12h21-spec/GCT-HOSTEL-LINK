      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="border border-border lg:col-span-1">
          <CardContent className="p-6 flex flex-col items-center text-center">
            ...
            <p className="text-xs text-muted-foreground mt-3">Upload profile photo (max 3MB, any format)</p>
          </CardContent>
        </Card>
          ...
          <Card className="border border-border">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                {[
                  ["Name", profile.name], ["Father's Name", profile.father_name],
                  ["Roll Number", profile.roll_number], ["Technology", profile.technology],
                  ["Room No", profile.room_no], ["Shift", profile.shift],
                  ["Hostel", profile.hostel], ["Email", profile.email],
                ].map(([k, v]) => (
                  <div key={k}>
              ...
              <div className="border-t border-border pt-4 space-y-4">
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Editable Information</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input className="mt-1.5" value={editForm.father_phone} onChange={(e) => setEditForm({ ...editForm, father_phone: e.target.value })} />
                  </div>
