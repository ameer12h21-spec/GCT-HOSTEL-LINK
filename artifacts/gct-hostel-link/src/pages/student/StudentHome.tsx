...
import { CalendarCheck, DollarSign, Zap, MessageSquare } from "lucide-react";
import { formatPKR } from "@/lib/utils";

export default function StudentHome() {
  const { profile } = useAuth();
  const [summary, setSummary] = useState({ presentCount: 0, absentCount: 0, messFee: null as any, electricityBill: null as any, openComplaints: 0 });
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-foreground">{summary.messFee ? formatPKR(summary.messFee.amount) : "Not Set"}</p>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-foreground">{summary.electricityBill ? formatPKR(summary.electricityBill.amount) : "Not Set"}</p>
