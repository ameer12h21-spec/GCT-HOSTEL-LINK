        ...
        <Card className="border border-border lg:col-span-1">
          <CardContent className="p-6 flex flex-col items-center text-center">
            <div className="relative mb-4">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center text-white text-3xl font-bold overflow-hidden">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border border-border">
            ...
            <CardContent className="space-y-4">
              ...
              <Button onClick={saveProfile} className="bg-gradient-to-r from-green-500 to-teal-600 text-white" disabled={saving}>
